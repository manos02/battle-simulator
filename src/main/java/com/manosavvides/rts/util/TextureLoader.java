package com.manosavvides.rts.util;
...
public class TextureLoader {
    ...
    private void initTextures() {
        textures.put("men(1)", getResourceFromPath(TEXTURE_DIR, FACTION_SUB_DIR, "men.png"));
        textures.put("elves(1)", getResourceFromPath(TEXTURE_DIR, FACTION_SUB_DIR, "elves.png"));
        textures.put("dwarves(1)", getResourceFromPath(TEXTURE_DIR, FACTION_SUB_DIR, "dwarves.png"));
        textures.put("mordor(2)", getResourceFromPath(TEXTURE_DIR, FACTION_SUB_DIR, "mordor.png"));
        textures.put("isengard(2)", getResourceFromPath(TEXTURE_DIR, FACTION_SUB_DIR, "isengard.png"));
